package com.example.videoplayer_and_downloader.SocialVideosDonwloader.appUtils;
...
public class TinyDB {
    ...
    public int getIntSortDate(String key) {
    ...
    public boolean getBooleanDownlaod(String key) {
...
//    }
    ...
    public <T>void putListObject(@NonNull String key, ArrayList<T> objArray) {
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for (T obj : objArray) {
