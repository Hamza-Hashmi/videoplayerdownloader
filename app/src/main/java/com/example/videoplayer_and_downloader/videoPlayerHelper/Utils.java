...
public class Utils {
    ...
    static boolean gestureEnabled = true;
...
//                | View.SYSTEM_UI_FLAG_HIDE_NAVIGATION);
    ...
    public static void setGestureEnabled(boolean gestureEnabled1) {
        gestureEnabled = gestureEnabled1;
    }

    public enum Orientation {
        LANDSCAPE(0, R.string.video_orientation_landscape),
        PORTRAIT(1, R.string.video_orientation_portrait),
        AUTO_ROTATE(2, R.string.video_orientation_auto);
    ...
    public static void setOrientation(Activity activity, Orientation orientation) {
        Log.e("orientation", "setOrientation:  orientation  "+orientation );
        ...
        switch (orientation) {
            case LANDSCAPE:
                ...
                //   }
            {
                Log.e("newOrientation", activity.getResources().getString(orientation.description));
    ...
    public static Orientation getNextOrientation(Orientation orientation) {
        switch (orientation) {
            ...
            default:
                return Orientation.AUTO_ROTATE;
        }
    }
